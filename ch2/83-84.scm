...
(define (put-raise type proc)
  (hash-set! *raise-table* type proc))
(define (get-raise type)
  (hash-ref *raise-table* type #f))
;; util
(define (square x) (* x x))
...
(define rn (make-rational 2 3))
(define ren (attach-tag 'real 4))
(define cn (make-complex-from-real-imag 5 6))
